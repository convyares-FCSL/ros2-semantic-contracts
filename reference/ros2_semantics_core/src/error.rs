// reference/ros2_semantics_core/src/error.rs
//! Crate-wide error aggregation.
//!
//! This module intentionally does **not** define policy outcomes (accept/reject decisions).
//! Policy outcomes are represented by explicit decision/result types in each domain.
//!
//! Key ideas:
//! - `CoreError` is the only error type intended to cross module boundaries in this crate.
//! - Module-local errors may exist, but should generally collapse into `CoreError` at boundaries.
...
impl ErrB {
    ...
    /// Replace payload (default is None).
    #[inline]
